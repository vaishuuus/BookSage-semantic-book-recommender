...
## Features
- **Personalized Recommendations**: Uses machine learning techniques to suggest books that match the user’s reading habits.
- **Semantic Analysis**: Evaluates the content of books and user inputs to ensure high-quality recommendations.
- **User-Friendly Interface**: Offers an intuitive interface for easy navigation and exploration of book options.

## Installation
1. Clone the repository:  
   `git clone https://github.com/vaishuuus/BookSage-semantic-book-recommender.git`
...
1. Run the application:  
   `python app.py`
2. Follow the on-screen instructions to access personalized book recommendations.
